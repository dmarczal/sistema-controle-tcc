    ...
    [
      {
        ...
        _type: 'important',
        description: 'O acadêmico deve solicitar a matrícula até 50 dias antes do término do semestre, via protocolo no DERAC.',
        base_timeline_id: id,
        link: '#',
        date: Date.new(year, first_month, 1)
      },
      {
      ...
      },
      {
        ...
        base_timeline_id: id,
        link: '#',
        date: Date.new(year, first_month+1, 10)
      },
      {
